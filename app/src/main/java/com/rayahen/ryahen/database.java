...
public class database  {
    ...
    public long updateToCart(Order order)
    {
        SQLiteDatabase data=db.getWritableDatabase();
        ...
        long id=data.update("orders_info",contentValues,"productId" + "=" + order.getProductId(),null);
        return id;
    }
    ...
    public long addToFav(FavoritModel favid)
    {
        SQLiteDatabase data=db.getWritableDatabase();
        ...
        contentValues.put("discrib",favid.getDescrepton());
        contentValues.put("kind",favid.getKind());
    ...
    public boolean IsCart(String favid)
    {
        SQLiteDatabase data=db.getWritableDatabase();

        String query=String.format("SELECT * FROM orders_info WHERE productId = '"+favid+"'");
    ...
    public boolean IsCartEmpty()
    {
        ...
        String query=String.format("SELECT count(*) FROM orders_info");
    ...
    public boolean IsFavEmpty()
    {
        ...
        String query=String.format("SELECT count(*) FROM favorit");
    ...
    public List<FavoritModel>getFavorit()
    {
        SQLiteDatabase data=db.getWritableDatabase();
        //SQLiteQueryBuilder qb =new SQLiteQueryBuilder();

        String[] sqlSelect={"productId","productName","discount","price","discrib","kind"};
        //String sqlTable="orders_info";
        ...
        while (c.moveToNext())
        {
            ...
            String pric=c.getString(3);
            String dis=c.getString(4);
            int kind=c.getInt(5);

            res.add(new FavoritModel(uid,
                    nam,
                    disc,
                    pric,dis,kind
            ));
...
class DB  extends SQLiteOpenHelper{
    ...
    public static final String discribtion="discrib";
    ...
    private static final String CREATE_TABLE2="CREATE TABLE "+table_fav +" ( "+uidfav +" VARCHAR(255)  , "+names+" VARCHAR(255) ,"+pa+" VARCHAR(255) ,"+pass+" VARCHAR(255),"+discribtion+" VARCHAR(255),"+kind+" VARCHAR(255));" ;
